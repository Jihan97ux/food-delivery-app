...
<body class="bg-white flex justify-center items-center h-screen">
    <div class="container flex justify-center items-center px-4">
        <div class="bg-white rounded-lg shadow-lg p-8 w-96 text-center">
            ...
            <form action="{{ url('restaurant_store') }}" method="POST">
                @csrf
                <input type="text" placeholder="Restaurant Name" name='nama_resto' value="{{ Session::get('nama_resto') }}" id="nama_resto"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-orange-400">
                <input type="text" placeholder="Category" name='kategori' value="{{ Session::get('kategori') }}" id="kategori"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-orange-400">
                <input type="email" placeholder="E-mail" name='email' value="{{ Session::get('email') }}" id="email"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-orange-400">
                <input type="tel" placeholder="No Telp" name='no_telp' value="{{ Session::get('no_telp') }}" id="no_telp"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-orange-400">
                <input type="text" placeholder="Address" name='alamat' value="{{ Session::get('alamat') }}" id="alamat"
                    class="w-full px-4 py-2 border border-gray-300 rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-orange-400">
